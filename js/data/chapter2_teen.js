...
const chapter2TeenData = {
    ...
    cardGallery: [
            ...
            },
            {
                ...
                title: "阿顯碗粿",
                summary: "以純米製作、搭配油蔥酥提味的50年傳統碗粿。",
                story: "阿顯碗粿創立於1974年，至今已傳承至第三代，是北斗在地超過50年的老字號。最初以麵食起家，後來碗粿逐漸成為代表性產品。其特色在於使用純米製作，不添加澱粉或在來米粉，呈現出扎實且Q彈的口感。碗粿本身沒有內餡，僅搭配醬油、菜脯與油蔥酥調味，看似簡單，卻透過香氣與口感的層次展現古早味的精髓。其中自製油蔥酥是關鍵元素，能明顯提升整體風味。由於每日限量供應，常在傍晚前即售完，也反映其在地受歡迎的程度。"
            }
        ],
